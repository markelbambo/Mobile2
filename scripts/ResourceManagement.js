...
function loadReserve(){
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationReserve&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
...
function loadReserveRelease(){
	...
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=getseldev&query=limit=10`page=1`resourceid='+globalResourceId;
	$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
...
function loadConnectivity(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationConnectivity&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
...
function loadPort(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationPort&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
	...
	$.ajax({
        ...
        success: function(data) {
			...
			$('#paginations').html(btns).trigger('create');
            for(var a =0; a< row.length; a++){
				html += "<tr class='trPort curl' rpId='"+row[a].getAttribute('ReservedPortId')+"'>";
				html += "<td>"+row[a].getAttribute('DeviceId')+"</td>";
...
function loadHistory(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationHistory&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
...
function loadDevices(){
	...
	var dateToday = date.getMonth()+1+'/'+date.getDate()+'/'+date.getFullYear()
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationDevice&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain='+domain+"`ZoneName="+zoneName+"`GroupName="+groupName;
	$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
...
//		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationDevice&query=limit=10`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain='+domain+"`ZoneName="+zone+"`GroupName="+group;
				...
				var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ReservationDeviceAffiliated&query=limit=10`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain='+domain+"`ZoneName="+zoneName+"`GroupName="+groupName;
	$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
...
function loadTesttoolHeader(){
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=getDeviceInformation&query='+DeviceId;
		$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
...
function loadTesttoolTable(){
	...
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=portinfos&query=id='+DeviceId;
		$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
...
function loadEventSched(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=EventScheduler&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
...
function loadHistorySched(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=HistoryScheduler&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
...
function loadManageDevice(){
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=ManageDevice&query=limit='+showMoreInfo+'`page=1`sort=`orderby=`user='+globalUserName+'`filter=`domain=`start=`status=`timezone='+timezone[0]+timezone[1]+timezone[2]+'^'+timezone[3];
	...
	$.ajax({
        ...
        success: function(data) {
            ...
            for(var a =0; a< row.length; a++){
				...
				if(row[a].getAttribute('MacAddress') == undefined || row[a].getAttribute('MacAddress') ==""){
					html+="<td>N/A</td>";
				}else{
					html += "<td>"+row[a].getAttribute('MacAddress')+"</td>";
			  	}
				if(row[a].getAttribute('ConsoleIP') == undefined || row[a].getAttribute('ConsoleIp') ==""){
					html+="<td>N/A</td>";
				}else{
				...
				if(row[a].getAttribute('SystemMemory') == undefined || row[a].getAttribute('SystemMemory') ==""){
					html+="<td>N/A</td>";
				}else{
					html += "<td>"+row[a].getAttribute('SystemMemory')+"</td>";
			  	}
				if(row[a].getAttribute('NVRAMCF') == undefined || row[a].getAttribute('NVRAMCF') ==""){
					html+="<td>N/A</td>";
				}else{
					html += "<td>"+row[a].getAttribute('NVRAMCF')+"</td>";
			  	}
...
function loadHistoryScheduler2(){
		...
		var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=geteventdevices&query=limit=10`page=1`mainid='+devdev1+'`status='+statsstats+'`eventid='+eventid1;
...
function loadHistoryScheduler3(){
	...
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=geteventinfo&query=eventid='+eventid1+"`status="+statsstats+"`mainid="+devdev1;
		$.ajax({
        url: url,
		dataType: 'html',
        success: function(data) {
 ...
 *  */
function loadImage(){
	//var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/AutoCompleteCgiQuerry_withDb/querYCgi.fcgi?action=getLoadImage&query=deviceid='+DeviceId;	
...
//	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/AutoCompleteCgiQuerry_withDb/querYCgi.fcgi?action=getLoadImageDetail&query=deviceid='+DeviceId;	
//
...
function deleteManageDevice(){
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=deletedevice&query=DeviceId='+DeviceId;
	$.ajax({
		url: url,
		dataType: 'html',
		success:function(data){
...
function getdevicetype(id){
	...
	var devType = '';
	var URL = 'https://'+CURRENT_IP+'/cgi-bin/Final/NFast_RM/NFastRMCGI.py?action=getdevicetype&query=ids='+id;
	$.ajax({
		url: URL,
		async: false,
		dataType: 'html',
...
console.log('yehey!');
	...
	var url = 'https://'+CURRENT_IP+'/cgi-bin/Final/AutoCompletePythonCGI/FastQueryCgi.py?action=verifyip&query=ip='+ipchk;
	$.ajax({
		url: url,
		dataType : 'html',
		success: function(data){
...
function autoRefreshTable(){
		console.log(globalPageRM,'LOLO JAMES');
	var command = "";
	...
	autoRefresh = setInterval(command,10000);
}
/*
 #######################################################################
 #
