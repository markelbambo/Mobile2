...
$(document).on('click', '#showGridline', function() {
	$("#showGridline").addClass('animated wobble');
	setTimeout(function(){
	showGrid();   	
	},1500);
});
$(document).on('click', '#editGridline', function() {
	$("#editGridline").addClass('animated wobble');
	setTimeout(function(){
